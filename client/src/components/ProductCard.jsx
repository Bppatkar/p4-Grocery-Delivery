          ...
          <div className="flex items-end justify-between mt-3">
            ...
            >
              {!cartItems[product._id] ? (
                <button
                  className="flex items-center justify-center gap-1 bg-[var(--color-primary)]/10  border border-[var(--color-primary)]/40  md:w-[80px] w-[64px] h-[34px] rounded cursor-pointer "
